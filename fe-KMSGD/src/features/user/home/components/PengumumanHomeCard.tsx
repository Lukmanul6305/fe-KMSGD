...
export default function PengumumanHomeCard({ item }: Props) {
    return (
        <article className="bg-[#20201f] border border-[#2a2a2a] hover:border-[#ffd700] transition-all duration-300 rounded-xl overflow-hidden group cursor-pointer flex flex-col h-full shadow-lg">
            ...
            <div className="p-5 flex flex-col grow justify-between">
                <div>
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="text-[#999077] text-xs">📅 {item.day} {item.month} 2025</span>
                    </div>
                    ...
                    <p className="text-[#d0c6ab] text-sm leading-relaxed line-clamp-3 mb-4">{item.desc}</p>
                </div>
