...
export default function MemberCard({
    ...
    if (variant === "ketua") {
        return (
            <div className={`inline-flex items-center gap-4 bg-[#151515] border border-[#ffd700]/20 px-5 py-4 ${className}`}>
                <div className="w-14 h-14 bg-[#222] shrink-0 flex items-center justify-center">
    ...
    if (variant === "demisioner") {
        return (
            <div className={`bg-[#1a1a1a] border border-[#2a2a2a] p-4 flex items-center gap-4 hover:border-[#ffd700]/30 transition ${className}`}>
                <div className="w-11 h-11 bg-[#202020] border border-[#333] shrink-0 flex items-center justify-center">
    ...
    return (
        <div className={`bg-[#151515] border flex items-center border-[#1f1f1f] p-5 hover:border-[#ffd700]/30 transition ${className}`}>
            <div className="w-12 h-12 bg-[#222] shrink-0 flex items-center justify-center">
